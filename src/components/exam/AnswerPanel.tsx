...
function saveTone(status: SaveStatus): string {
  ...
  if (status === "local") return "text-soft";
  return "text-soft";
}
...
export default function AnswerPanel({
  ...
  return (
    <aside className="space-y-3 border border-line bg-raised p-4">
      <p className="font-mono text-[10px] uppercase tracking-widest text-soft">Answer panel</p>
      ...
      <p className="font-mono text-[11px] text-soft">{draftedCount} answers drafted</p>
