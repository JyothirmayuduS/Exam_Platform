...
export default function TeacherDashboard() {
  ...
  return <RoleLayout role="Teacher" name="Dr. K. Venkatesh" subtitle="Computer Science · Faculty" tone="#284B34" items={nav}>
    {section === "overview" && <Overview notify={notify} navigate={navigate} examsList={createdExams} loading={loadingExams} />}
...
function Overview({ notify, navigate, examsList, loading }: { notify: (s: string) => void; navigate: (s: string) => void; examsList: any[]; loading: boolean }) {
